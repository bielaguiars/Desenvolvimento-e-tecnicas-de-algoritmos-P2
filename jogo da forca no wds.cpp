...
char bancoPalavras[MAX_PALAVRAS_BANCO][MAX_PALAVRA] = {"EDMAMA", "NOVOPAI", "JOSIFADA", "RAINHA DA NOITE", "DOUBLE DJ"};
...
void mostrarResultado(int resultado) {
    printf("\n");
    if (resultado == 0) {
        printf("Você perdeu e sua mãe de o cu para todos do grupo. A palavra era %s\n", palavra);
        exit(0);
    } else {
        printf("Parabéns, você acertou sua mãe é uma puta barata %s\n", palavra);
        exit(0);
    }
}
